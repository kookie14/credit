...
class AustralianDataset(Dataset):
    ...
    def _set_column_names(self):
        self.raw_data.columns = [
            "A"+str(i) for i in range(1, 15)] + [self.class_column_name]
...
if __name__ == "__main__":
    ...
    taiwan_data = AustralianDataset(
        data_path="/home/cuctt/credit/data/australian/australian.dat", class_column_name="class")
    print(taiwan_data.raw_data.head())